...
function Classthreepage({db}){
    ...
    const getStudents = () => {
        ...
        const nms = []
        const grades = []
        getDocs(collection(db, "Class/Class3/Class3Students"))  // get the collection
        .then((allResponses) => {  // format each response into an array as we want it
    ...
    const addResponse = (e) => {
        ...
        setDoc(doc(db, "Class/Class3/Class3Students", otherRef.current.value),data) // add the new response 
    ...
    const deleteResponse = (e) => {
      ...
      deleteDoc(doc(db,"Class/Class3/Class3Students", textFieldRef.current.value))
    ...
    const editGrade = (e) => {
      ...
      updateDoc(doc(db,"Class/Class3/Class3Students", editRefOne.current.value),{
    ...
    const tableEditGrade = (input1) => {
      ...
      updateDoc(doc(db,"Class/Class3/Class3Students", input1),{
