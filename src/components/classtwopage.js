...
function Classtwopage({ db }) {
  ...
  const addResponse = (e) => {
    ...
    setDoc(
      doc(db, "Class/Class2/Class2Students", otherRef.current.value),
      data
  ...
  const deleteResponse = (e) => {
    ...
    deleteDoc(
      doc(db, "Class/Class2/Class2Students", textFieldRef.current.value)
    );
  ...
  const editGrade = (e) => {
    ...
    updateDoc(
      doc(db, "Class/Class2/Class2Students", editRefOne.current.value),
      {
        ...
        <div>
          ...
          <h3>
            {console.log(
              ...
              studentsArray[0].Class2Student1
            )}
          </h3>
