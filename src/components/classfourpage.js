...
function Classfourpage({db}){
    ...
    const addResponse = (e) => {
        ...
        setDoc(doc(db, "Class/Class4/Class4Students", otherRef.current.value),data) // add the new response 
    ...
    const deleteResponse = (e) => {
      ...
      deleteDoc(doc(db,"Class/Class4/Class4Students", textFieldRef.current.value))
    ...
    const editGrade = (e) => {
      ...
      updateDoc(doc(db,"Class/Class4/Class4Students", editRefOne.current.value),{
