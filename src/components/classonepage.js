...
function Classonepage({ db }) {
  ...
  const editGrade = (e) => {
    ...
    updateDoc(
      doc(db, "Class/TestClass1/TC1Students", editRefOne.current.value),
      {
    ...
    return (
      <div>
        <div>
          ...
          <h3 className="display">Class: {responses[3].ClassName}</h3>
          <h3 className="display">Subject: {responses[3].Subject}</h3>
          <h3 className="display">
            Teacher: {responses[3].Teacher._key.path.segments[6]}
          </h3>
